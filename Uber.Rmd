...
The analysis of traffic in a city can be very important to detect areas which are usually more congested, the time at which this occurs and for how long. Being able to estimate these three variables with precision would be very useful to carry out better urban planning. With this project we intend to make an approximation to this analysis using the traffic flow of Uber users as data.
