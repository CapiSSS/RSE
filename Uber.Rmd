...
```{r}
# NO FUNCIONA. CAMBIAR.
img1 <- readPNG("C:/Users/Sergio/Desktop/MÁSTER/2º/REDES SOCIALES Y ECONÓMICAS/PROYECTO/repositorio/RSE/img/betweenness.com/10.png", native = TRUE, info = TRUE)
```
...
```{r}
# NO FUNCIONA. CAMBIAR.
img1 <- readPNG("C:/Users/Sergio/Desktop/MÁSTER/2º/REDES SOCIALES Y ECONÓMICAS/PROYECTO/repositorio/RSE/img/fast.greedy.com/10.png", native = TRUE, info = TRUE)
```
...
```{r}
# NO FUNCIONA. CAMBIAR.
img1 <- readPNG("C:/Users/Sergio/Desktop/MÁSTER/2º/REDES SOCIALES Y ECONÓMICAS/PROYECTO/repositorio/RSE/img/label.prop.com/10.png", native = TRUE, info = TRUE)
```
...
```{r}
# NO FUNCIONA. CAMBIAR.
img1 <- readPNG("C:/Users/Sergio/Desktop/MÁSTER/2º/REDES SOCIALES Y ECONÓMICAS/PROYECTO/repositorio/RSE/img/walktrap.com/10.png", native = TRUE, info = TRUE)
```
